...
import type { TimelinesData, TimelineEvent } from '@/lib/types';
...
export default function TimelineTab({ institutionId }: TimelineTabProps) {
  const data = timelinesData as TimelinesData;
  const events: TimelineEvent[] = data.timelines[institutionId] ?? [];
