...
export default function InstitutionCard({ institution, onSelect }: InstitutionCardProps) {
  ...
  const isEmperor = institution.id === 'emperor';
  ...
  return (
    <motion.article
      ...
      style={{
        ...
        borderColor: isEmperor ? 'rgba(184, 134, 11, 0.45)' : `${palette.border}44`,
      }}
    >
      <div
      ...
      <div className="relative flex h-full flex-col gap-5">
        ...
        <div className="space-y-3">
          <div>
            <h3
              className={`font-heading text-2xl tracking-[0.28em] ${isEmperor ? 'text-[2rem]' : ''}`}
