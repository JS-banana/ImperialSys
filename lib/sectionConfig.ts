...
export const SECTION_CONFIG: NarrativeSection[] = [
  {
    id: 'imperial-core',
    title: '皇权独尊',
    navLabel: '皇权',
    ...
    intraRelationIds: [],
    interRelationIds: ['r_emp_cabinet', 'r_emp_sili', 'r_emp_jinyi', 'r_emp_wujun'],
  },
  {
    id: 'central-balance',
    title: '票拟与批红',
    ...
    intraRelationIds: ['r_cabinet_sili'],
    interRelationIds: [
      'r_cabinet_libu',
      'r_cabinet_hubu',
      'r_cabinet_libu2',
    ...
    diagramVariant: 'cabinet-silijian',
  },
  {
    id: 'administration',
    title: '六部执行',
  ...
  },
  {
    ...
    interRelationIds: [],
    diagramVariant: 'three-judicial-offices',
  },
  {
    id: 'military',
    title: '军政分离',
    ...
    intraRelationIds: ['r_bingbu_wujun'],
    interRelationIds: [],
    diagramVariant: 'military-balance',
  },
  {
    id: 'secret-police',
    title: '暗处之眼',
    ...
    intraRelationIds: ['r_sili_dongchang', 'r_dongchang_jinyi'],
    interRelationIds: [],
    diagramVariant: 'secret-surveillance',
  },
];
